...
public abstract class ListNode <N> {
   ...
   *  Performance:  runs in O(1) time.
   */
  public N item() throws InvalidNodeException {
    if (!isValidNode()) {
   ...
   *  Performance:  runs in O(1) time.
   */
  public void setItem(N item) throws InvalidNodeException {
    if (!isValidNode()) {
      throw new InvalidNodeException();
    }
    this.item = item;
   ...
   */
  public abstract ListNode<N> next() throws InvalidNodeException;
   ...
   *  @exception InvalidNodeException if this node is not valid.
   */
  public abstract ListNode<N> prev() throws InvalidNodeException;
   ...
   *  @exception InvalidNodeException if this node is not valid.
   */
  public abstract void insertAfter(N item) throws InvalidNodeException;
   ...
   *  @exception InvalidNodeException if this node is not valid.
   */
  public abstract void insertBefore(N item) throws InvalidNodeException;
